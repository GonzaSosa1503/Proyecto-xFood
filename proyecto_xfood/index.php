...
<html lang="es">
    ...
    <body class="black">
        <!-- Responsive navbar-->
        <nav class="navbar navbar-expand-lg navbar-dark black border-bottom border-warning">
            <div class="container px-lg-5 bs">
                <a class="navbar-brand text-warning" href="#!"><img src="./img/xFood.png" height="32px"></a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link active text-warning" aria-current="page" href="#!">inicio</a></li>
    ...
    <div class="container px-lg-5">
        <div class="p-4 p-lg-5 black rounded-3 text-center">
            <div class="m-4 m-lg-5">
                ...
                <a class="btn btn-warning btn-lg" href="#!">¡Realiza tu pedido ahora!</a>
            </div>
        </div>
    </div>
</header>
...
<section class="black py-5">
    <div class="container px-5 my-5 px-5">
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bolder text-warning">envianos un comentario</h2>
            <p class="lead mb-0 text-warning">¡lo apreciamos mucho!</p>
        </div>
